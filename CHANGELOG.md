...
- Add CORS headers to synthetic APQ rejection responses
  ([`dcf391e`](https://github.com/romain-gilliotte/spectral/commit/dcf391e2f69aa845d6ddc472c6f024c65998e051))
...
- Add pypi environment to publish workflow
  ([`fc9c79e`](https://github.com/romain-gilliotte/spectral/commit/fc9c79e271c41be1f0d75eacc55150a0452ce0e5))
...
- Add strict type annotations and fix all linting issues
  ([`2f2b7d6`](https://github.com/romain-gilliotte/spectral/commit/2f2b7d66ff7acc281e9c92125bab999d9be8118d))
...
- Add strict type annotations to test files
  ([`9dec4df`](https://github.com/romain-gilliotte/spectral/commit/9dec4df22b4348e02d37c9fa64c8ae6f6fd9beca))
...
- Address 6 bugs found during code review
  ([`e7da6ca`](https://github.com/romain-gilliotte/spectral/commit/e7da6ca48ec59e68f26418ad5e85ccd023320bd7))
...
- Apply default parameter values in MCP server
  ([`b6a8d4d`](https://github.com/romain-gilliotte/spectral/commit/b6a8d4d937f83f03defa7952cda950d70b6119b1))
...
- Cache base_url in detect_base_url after LLM detection
  ([`725ef9e`](https://github.com/romain-gilliotte/spectral/commit/725ef9ed586007fe8938f5790e22c576a77004b0))
...
- Capture HTTP redirect responses in Chrome Extension
  ([`5eb9ac6`](https://github.com/romain-gilliotte/spectral/commit/5eb9ac6a54d6261f2850b50f55ceca2673102d62))
...
- Coerce MCP string arguments to declared schema types
  ([`1633859`](https://github.com/romain-gilliotte/spectral/commit/16338598f6d3ab0600b8e9be9f16abc33cd9aaed))
...
- Compact_url no longer produces `:///path` on relative URLs
  ([`d61d971`](https://github.com/romain-gilliotte/spectral/commit/d61d9717f05a9c7f96ae4c0456295652cdf9a413))
...
- Convert Chrome monotonic timestamps to epoch ms
  ([`fbe11c4`](https://github.com/romain-gilliotte/spectral/commit/fbe11c4bf42ad8da145d7237048359e8f8e14e42))
...
- Convert glob-style domain patterns to valid regex for mitmproxy
  ([`0175ae0`](https://github.com/romain-gilliotte/spectral/commit/0175ae026386f9210c376694b647ac0b459265bd))
...
- Detect GraphQL by request body only, support persisted queries and batches
  ([`b02b63c`](https://github.com/romain-gilliotte/spectral/commit/b02b63c368f24cb4b21476e754b92930c2330845))
...
- Exclude auth endpoints from MCP tool identification
  ([`13e6c01`](https://github.com/romain-gilliotte/spectral/commit/13e6c01fd99ee30ed9dbaf8e70099f53424a38be))
...
- Filter traces by HTTP method in _find_traces_for_group
  ([`5074e8b`](https://github.com/romain-gilliotte/spectral/commit/5074e8ba21cbf812aca2c86409ae8c11c23b08c1))
...
- Fixed palette and shell bg padding in demo GIF chrome
  ([`05cfb27`](https://github.com/romain-gilliotte/spectral/commit/05cfb27469566c8593ca0f63fc5f8d2d65d487b9))
...
- Harden Chrome extension for MV3 compatibility
  ([`bc5fd2e`](https://github.com/romain-gilliotte/spectral/commit/bc5fd2eea66afbdfc056978be03b792c69d6286e))
...
- Prevent cache_control pollution across LLM tool calls
  ([`77df4da`](https://github.com/romain-gilliotte/spectral/commit/77df4da1c66fcad0ddfaa9ff4333ca1947588593))
...
- Readme
  ([`4a58bd5`](https://github.com/romain-gilliotte/spectral/commit/4a58bd516d42bada00b013f7a7e560c75f2b893a))

- Remove build_command from semantic-release config
  ([`1995c6e`](https://github.com/romain-gilliotte/spectral/commit/1995c6e0af45bf81f1e17d0ea7a8405011f5a95c))
...
- Remove GraphQL type-name fallback from field names
  ([`1410302`](https://github.com/romain-gilliotte/spectral/commit/1410302aae4ecc548cf7b1a18d7dd0280f1feb48))
...
- Remove weak `required` heuristic from body/response/query schemas
  ([`d1e8a17`](https://github.com/romain-gilliotte/spectral/commit/d1e8a17646b1ac59dccb664fc60b5a7b28cc3e9b))
...
- Restore transparent corners in demo GIF chrome
  ([`35d20b6`](https://github.com/romain-gilliotte/spectral/commit/35d20b64f2b23cf92311280b6b5bb8c509156236))
...
- Strip @null resource refs from manifest to survive apktool recompile
  ([`6229118`](https://github.com/romain-gilliotte/spectral/commit/62291189fe243b1a18f28f977adb44dac20fa0ce))
...
- Strip observed from intermediate schema nodes in LLM context only
  ([`7a6f0d5`](https://github.com/romain-gilliotte/spectral/commit/7a6f0d5b866505dfec89c9a68db201b6b094a2c4))
...
- Update all test files to use setup_client() instead of patching sys.modules
  ([`a0633d1`](https://github.com/romain-gilliotte/spectral/commit/a0633d191d42f1d3eaa83183373382b31ee75d4f))
...
- Use examples (array) instead of deprecated example in OpenAPI 3.1 output
  ([`bf7178e`](https://github.com/romain-gilliotte/spectral/commit/bf7178efd117751b83abfd40fccade09fc8774d1))
...
- Add .gitignore and remove cached bytecode files
  ([`bbd6d05`](https://github.com/romain-gilliotte/spectral/commit/bbd6d05cb7240d8a860493f0691fe1a58d32813e))

https://claude.ai/code/session_01VKC5tYNK4YGHJxhqvTbEeE

- Update .gitignore with env, debug, and generated artifacts
  ([`10b5c87`](https://github.com/romain-gilliotte/spectral/commit/10b5c8782b61a401b733a116abff9d25300e44c9))
...
- Replace chafa braille logo with hand-crafted spectrum analyzer ASCII art
  ([`3d9b9b1`](https://github.com/romain-gilliotte/spectral/commit/3d9b9b1be7b5a8ea48c235b9db66bed00654cd93))
...
- Add anchor links and reorder README sections
  ([`647b2a3`](https://github.com/romain-gilliotte/spectral/commit/647b2a3d392ada2e6886eb63d90d6036ee231f01))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Add banner to README
  ([`d75090d`](https://github.com/romain-gilliotte/spectral/commit/d75090da4df3ab4b1c606d0a7b469cc187b75fdd))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Add claude.md
  ([`64a02c7`](https://github.com/romain-gilliotte/spectral/commit/64a02c72e7e2f91dbd28d730e4979c28e78405b7))

- Add implementation status section to CLAUDE.md
  ([`4fc918e`](https://github.com/romain-gilliotte/spectral/commit/4fc918ef3fff318a13e8cea4b08b0d96eae84d2f))
...
- Add MCP server design document
  ([`a3f652a`](https://github.com/romain-gilliotte/spectral/commit/a3f652ab397e11f8ea5414ba46d2f2d60eb09cf8))
...
- Add MkDocs Material documentation site with GitHub Pages deployment
  ([`fb573f7`](https://github.com/romain-gilliotte/spectral/commit/fb573f7d03346a6b2ce9f82f59dbf4ec3afbd099))
...
- Add README and MIT license for public release
  ([`ac6df96`](https://github.com/romain-gilliotte/spectral/commit/ac6df96326cec975835f0678faeefb40b015d2a4))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Add target output format and analyze stage documentation
  ([`bcf2f99`](https://github.com/romain-gilliotte/spectral/commit/bcf2f9931446f0232746258a8547a5ab03ddaba4))
...
- Add theme-aware banner for GitHub light/dark modes
  ([`6a6afae`](https://github.com/romain-gilliotte/spectral/commit/6a6afae0ccdf6d3dd17bc95ee55b92ab5d0ab1dd))
...
- Add window chrome, match real Claude Code output format
  ([`5f54536`](https://github.com/romain-gilliotte/spectral/commit/5f545365649d844e4187b5a46fdeacf6f25aae1e))
...
- Convert feature highlights to bullet list in README
  ([`8454f98`](https://github.com/romain-gilliotte/spectral/commit/8454f98c03b9b5f3ce2acd34083d2ba8a61d776c))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Document three GraphQL request patterns and detection logic
  ([`32f1d6e`](https://github.com/romain-gilliotte/spectral/commit/32f1d6e6f0832bc4aff1110c9945f9e7c2aebb3b))
...
- Fix README heading levels for MITM proxy sections
  ([`d6ede9c`](https://github.com/romain-gilliotte/spectral/commit/d6ede9c733ccd025cc6f904630ea6411201521d2))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Fix stale references to old auth workflow and two-stage pipeline
  ([`62ea560`](https://github.com/romain-gilliotte/spectral/commit/62ea56009e6f72e8dc2d7ffdebf6743e2e0f5c5a))
...
- Lighter chrome, shorter analyze, more time on Claude section
  ([`56dea37`](https://github.com/romain-gilliotte/spectral/commit/56dea3742ff7d3f729f82d55562586fad4fb2e3a))
...
- Lighter title bar #586069, crop agg corners, spacing between prompts
  ([`dbbc324`](https://github.com/romain-gilliotte/spectral/commit/dbbc3246ab853093c941a385cfdbaa79fed221e6))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Remove _documentation/ superseded by CLAUDE.md
  ([`fe608cb`](https://github.com/romain-gilliotte/spectral/commit/fe608cbace3a6e39cc41b26c734ef9ddf6173ca1))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Replace real product names with generic examples in documentation
  ([#2](https://github.com/romain-gilliotte/spectral/pull/2),
  [`8c654c9`](https://github.com/romain-gilliotte/spectral/commit/8c654c9466068318d00ba85f60453a9716f2b2bc))
...
- Resize demo GIF to fit GitHub README width (789x455)
  ([`8de7838`](https://github.com/romain-gilliotte/spectral/commit/8de783831f90ac00d3721e6e08c63b366e392f71))
...
- Restructure documentation for user-facing clarity
  ([`92e64ea`](https://github.com/romain-gilliotte/spectral/commit/92e64ea08b43a9d124eeb40af3e6e361ea33e5bc))
...
- Revamp README with demo GIF and feature highlights
  ([`7a6ce5c`](https://github.com/romain-gilliotte/spectral/commit/7a6ce5c52e8b3cedce5133a79700239c2dcdad35))
...
- Round top corners of terminal window chrome
  ([`ee21cc4`](https://github.com/romain-gilliotte/spectral/commit/ee21cc4d03b8e8bc963c7e9a1032b39bc29ca149))
...
- Streamline README, link to documentation site
  ([`04ff692`](https://github.com/romain-gilliotte/spectral/commit/04ff692c5dae8369d403bd9d049bbb38380bc99d))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Sync CLAUDE.md with restructured test suite and current state
  ([`987f362`](https://github.com/romain-gilliotte/spectral/commit/987f362431d10539f55f8565dee4fbd844be22ad))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Transparent rounded corners on terminal window chrome
  ([`59374f0`](https://github.com/romain-gilliotte/spectral/commit/59374f09347b414bc05f1683facd7b438c91d1f0))
...
- Update CLAUDE.md with current architecture
  ([`7d27758`](https://github.com/romain-gilliotte/spectral/commit/7d2775803882de6cd88f38bd09ee0320c19a5769))
...
- Update CLAUDE.md with GraphQL support and new project structure
  ([`3eee4c4`](https://github.com/romain-gilliotte/spectral/commit/3eee4c47a93e971e9af71983e0e2b54bc4b883c4))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Update dev environment instructions for uv and dotenv
  ([`347c9e5`](https://github.com/romain-gilliotte/spectral/commit/347c9e5f083ded62807c53ce95e3f8745fdace33))
...
- Update documentation for auth extract, login fix, and pipeline changes
  ([`6fba141`](https://github.com/romain-gilliotte/spectral/commit/6fba141f3d331fddd00d5145c2b0df55faedc706))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Update documentation to match current implementation
  ([`a15089b`](https://github.com/romain-gilliotte/spectral/commit/a15089b927b324cb89f30764199f454b20d93ec3))
...
- Update README and CLAUDE.md to reflect current codebase
  ([`1bfc4f1`](https://github.com/romain-gilliotte/spectral/commit/1bfc4f112b0bdb4f0ec07a8e5f7798058430283f))
...
- Update README and CLI reference for MCP tools and auth commands
  ([`5ba5af9`](https://github.com/romain-gilliotte/spectral/commit/5ba5af967f246c550761ea3260a6166ae230bbe2))
...
- Update README, CLAUDE.md, and documentation for managed storage
  ([`7555fbf`](https://github.com/romain-gilliotte/spectral/commit/7555fbf62b47aa3225444a290b08153fe138b41e))
...
- Update README, refresh branding assets and extension icons
  ([`77e6429`](https://github.com/romain-gilliotte/spectral/commit/77e6429b3d507ef898ebc2cb71b0b13282513f9c))
...
- Add --skip-enrich flag and simplify .gitignore
  ([`135e5be`](https://github.com/romain-gilliotte/spectral/commit/135e5bec0357ea3771bc149f6b6993126af069b2))
...
- Add `auth set` command for manual token injection
  ([`145f7e0`](https://github.com/romain-gilliotte/spectral/commit/145f7e0fb1d44b3fe0ba49b9dd04640826a09864))
...
- Add `spectral mcp install` command
  ([`f3ae186`](https://github.com/romain-gilliotte/spectral/commit/f3ae186dee415969f71277c5652f72a39b3d87ab))
...
- Add Android APK capture pipeline (pull, patch, MITM proxy)
  ([`4ea317d`](https://github.com/romain-gilliotte/spectral/commit/4ea317db1fefa33368480922e802a51296586d28))
...
- Add auth grab flow via extension and native messaging
  ([`5ad17b1`](https://github.com/romain-gilliotte/spectral/commit/5ad17b1426e861033810a16ba1085072aafe3726))
...
- Add braille logo banner to CLI help output
  ([`685cb47`](https://github.com/romain-gilliotte/spectral/commit/685cb47b3aa7b75e90a7b6d8d93cef1440726213))
...
- Add bundle merging and wire analyze command to managed storage
  ([`5570ebc`](https://github.com/romain-gilliotte/spectral/commit/5570ebc53af49cdd439e1ab007a4031412a18eda))
...
- Add call command, structured auth configs, and flexible auth in generators
  ([`57ae5d4`](https://github.com/romain-gilliotte/spectral/commit/57ae5d404866ae1c71b6460d528879df98f35dd9))
...
- Add GraphQL interception settings to popup UI
  ([`9ffca9c`](https://github.com/romain-gilliotte/spectral/commit/9ffca9c311ee089d45a1dcaf496e582b7065a872))
...
- Add GraphQL support and reorganize extension into subdirectories
  ([`8f0d0b2`](https://github.com/romain-gilliotte/spectral/commit/8f0d0b2a8e987bb3bdefcd27f00fd651f21200f3))
...
- Add host_permissions for content script re-injection
  ([`d9ca709`](https://github.com/romain-gilliotte/spectral/commit/d9ca70945aee641d384c90d5902a4e04e421eab5))
...
- Add install script and update docs for uv tool install workflow
  ([`2135a88`](https://github.com/romain-gilliotte/spectral/commit/2135a889d9798f7a990c7bedf034687a2f585a37))
...
- Add LLM investigation tools, URL compaction, and debug logging
  ([`1e1f7d3`](https://github.com/romain-gilliotte/spectral/commit/1e1f7d3ca55aae9067eff8f46ab6b1f2c661fc6f))
...
- Add managed storage layer and capture CLI commands
  ([`6c3feac`](https://github.com/romain-gilliotte/spectral/commit/6c3feac8eb1db3d6286ade4726706629a243067f))
...
- Add MCP pipeline, server, query commands, and tool/auth storage
  ([`4741a67`](https://github.com/romain-gilliotte/spectral/commit/4741a676987fc798d6691c1a0c0f29e739bd56fe))
...
- Add python-dotenv support and API client retry
  ([`8dbf09a`](https://github.com/romain-gilliotte/spectral/commit/8dbf09aa61a556c19a3d76568ae4df00141bd849))
...
- Add requires_auth field to ToolDefinition and gate auth in MCP server
  ([`eb9d84b`](https://github.com/romain-gilliotte/spectral/commit/eb9d84b2f8523f17940ddecf2a25e6a6ed979b07))
...
- Add shell completion for bash and zsh
  ([`423040e`](https://github.com/romain-gilliotte/spectral/commit/423040eacbcf2578d906b422dc222c8cc2e5e89c))
...
- Add system parameter to llm.ask() for prompt caching
  ([`fcf984c`](https://github.com/romain-gilliotte/spectral/commit/fcf984c7fec6d7476ca1d3ac5e94276b5109d448))
...
- Add tell_user, wait_user_confirmation, and debug helpers to auth scripts
  ([`203fbbe`](https://github.com/romain-gilliotte/spectral/commit/203fbbec39e9c8cf02ca1149049236b5ae35f662))
...
- Capture ExtraInfo headers and re-inject content script on navigation
  ([`cbf0afd`](https://github.com/romain-gilliotte/spectral/commit/cbf0afd41e4ba7bf03bc20babbd73006ecaf86f7))
...
- Detect dynamic map keys in JSON schema inference
  ([`7ce51e6`](https://github.com/romain-gilliotte/spectral/commit/7ce51e6ff3d4c4be0487a8f25973db01ab328e56))
...
- Detect enum types from literal argument values in GraphQL queries
  ([`3a9ab5b`](https://github.com/romain-gilliotte/spectral/commit/3a9ab5bf9c65c459af96992bffe93b7850ec3afa))
...
- Detect named-operation GraphQL requests (Reddit-style)
  ([`c522219`](https://github.com/romain-gilliotte/spectral/commit/c52221924408000ac3ecf7e47581dade39804a4d))
...
- Display real-time LLM token usage during analysis
  ([`b30551f`](https://github.com/romain-gilliotte/spectral/commit/b30551f0f22a30aec443953b7f841587e0bf1310))
...
- Drop large response schemas from enrichment prompt to prevent truncation
  ([`a9c3199`](https://github.com/romain-gilliotte/spectral/commit/a9c31995f3f9ce84213a036111fdbce30904d776))
...
- Extract auth tokens from captured traces
  ([`133cdea`](https://github.com/romain-gilliotte/spectral/commit/133cdea52f13bb46f5b1db725fbc1713e188e0d7))
...
- Filter traces by LLM-detected API base URL before analysis
  ([`d168f32`](https://github.com/romain-gilliotte/spectral/commit/d168f321afb6ec3ebde863cbbe97e1ae50392db4))
...
- Generate Restish config and LLM-powered auth helper from analyze output
  ([`c64a165`](https://github.com/romain-gilliotte/spectral/commit/c64a1657e0b03744a69765b4c5c0bfeea08a8b3c))
...
- Implement api-discover CLI pipeline (Phases 1-4)
  ([`735c983`](https://github.com/romain-gilliotte/spectral/commit/735c9839ecf11c01af6964df6a592d6d71fdb031))
...
- Implement Chrome extension for network/UI capture
  ([`28063ff`](https://github.com/romain-gilliotte/spectral/commit/28063ff2b16301fcc8825fd3fab0068bacaa0cb7))
...
- Improve extension UX, permissions, and store readiness
  ([`90c0f27`](https://github.com/romain-gilliotte/spectral/commit/90c0f27f118d09d656e9284b5832d452672634d1))
...
- Interactive auth script fix on login failure
  ([`39389d2`](https://github.com/romain-gilliotte/spectral/commit/39389d2afb15c9b25657b03ebd6d44cc2460f9ec))
...
- Migrate API key from .env to managed storage
  ([`b4525c6`](https://github.com/romain-gilliotte/spectral/commit/b4525c685568b37d31ac27679b8c942137fd7f8f))
...
- Populate previously-empty spec fields (format, rate_limit, discovery_notes, constraints, response
  ...
  ([`45bee7a`](https://github.com/romain-gilliotte/spectral/commit/45bee7aa0ab5e1385fce3b7c2f4f3994d97ecce9))
...
- Publish to PyPI as spectral-mcp with automated releases
  ([`aa4c388`](https://github.com/romain-gilliotte/spectral/commit/aa4c3885e10275aa1ff666ea14c16562241d3448))
...
- Reject persisted queries with PersistedQueryNotFound to force full query retry
  ([`6d41213`](https://github.com/romain-gilliotte/spectral/commit/6d412136cd56066d204af69be24de047242759db))
...
- Replace Click shell_complete with static completion scripts
  ([`e831456`](https://github.com/romain-gilliotte/spectral/commit/e831456a97d48e73b3ea7ead14dd6cc73ee07a78))
...
- Replace find_traces with jq-powered query_traces tool
  ([`cdf8c41`](https://github.com/romain-gilliotte/spectral/commit/cdf8c4152f3f88cde93dc0ff1c5de4bd9c2dde86))
...
- Replace ZIP export with Chrome Native Messaging
  ([`df87eae`](https://github.com/romain-gilliotte/spectral/commit/df87eae7ca5879c5468c4472022b8a318176995a))
...
- Restructure MCP prompts for prompt caching with system blocks
  ([`27f9e8c`](https://github.com/romain-gilliotte/spectral/commit/27f9e8cf94687f6c9cec9fde5da07a293917b864))
...
- Minify JSON in LLM input/output to reduce token usage
  ([`24dcd42`](https://github.com/romain-gilliotte/spectral/commit/24dcd428bd3f819765e92445a1425e6276ebdd19))
...
- Use compact JSON in LLM prompts to reduce token usage
  ([`9a27be8`](https://github.com/romain-gilliotte/spectral/commit/9a27be8b6e7127230f00f6286a7524a901d931a1))
...
- Centralize pipeline intermediate types into steps/types.py
  ([`740075c`](https://github.com/romain-gilliotte/spectral/commit/740075c0cd1f06ae8949aefb8650acb9e6e24112))
...
- Collapse auth analysis into single script-generation step
  ([`acc3901`](https://github.com/romain-gilliotte/spectral/commit/acc39018af25e80924034e4a3b697932d18653d0))
...
- Consolidate LLM calls into single ask() entry point
  ([`3675bf5`](https://github.com/romain-gilliotte/spectral/commit/3675bf577f811456f9ff9e3db01639ca0fd0014f))
...
- Consolidate schemas.py public interface to 2 functions
  ([`eb7a974`](https://github.com/romain-gilliotte/spectral/commit/eb7a974401bbbe6b0ae9e3ba19349d948c81a6c4))
...
- Deduplicate helpers across llm, extraction, schemas, and loader
  ([`8821d50`](https://github.com/romain-gilliotte/spectral/commit/8821d50f2b0581badaeef5ddb31adf64c42ae58b))
...
- Dissolve shared analyze/ pipeline, each command owns its analysis
  ([`3027d99`](https://github.com/romain-gilliotte/spectral/commit/3027d99ddecd78cba8594287c8290598a3cc94ed))
...
- Extract centralized LLM helper with rate-limit retry and concurrency control
  ([`7b3ee27`](https://github.com/romain-gilliotte/spectral/commit/7b3ee2708e05d988e19c1537e7433e9b2796e6a1))
...
- Extract cli/helpers/schema/ package from json/ and schemas.py
  ([`f2f8b54`](https://github.com/romain-gilliotte/spectral/commit/f2f8b544fd592c77cc6a2df4cb133043acc024b3))
...
- Extract external_tools package from android commands
  ([`e3df0be`](https://github.com/romain-gilliotte/spectral/commit/e3df0be53e3d0d8fa1f4a4d2d6a105e1cd7f2c83))
...
- Extract generic JSON helpers into cli/helpers/json/
  ([`3289b95`](https://github.com/romain-gilliotte/spectral/commit/3289b95d6ac0c7cba1ac9648a0908aa399a8dbb9))
...
- Extract inline prompts into Jinja2 templates
  ([`fd1904c`](https://github.com/romain-gilliotte/spectral/commit/fd1904ce062c0dd621ec0458536c367f25063a15))
...
- Extract inspect implementation from cmd.py into inspect.py
  ([`99a6122`](https://github.com/romain-gilliotte/spectral/commit/99a6122d8715de5c806c8c31623387e564f307e0))
...
- Extract shared helpers from command packages (naming, subprocess, http)
  ([`1012b47`](https://github.com/romain-gilliotte/spectral/commit/1012b4713d27478ab2fa83e944911e37b52e839f))
...
- Extract shared mitmproxy infra and GraphQL injection from proxy.py
  ([`881324e`](https://github.com/romain-gilliotte/spectral/commit/881324ee83dbc70e51470c83645d4cfca98b7b12))
...
- Extract subcommands from cmd.py into individual modules
  ([`87af1f7`](https://github.com/romain-gilliotte/spectral/commit/87af1f7b8845c07380e401958c05977ae59ad207))
...
- Greedy per-trace MCP pipeline with response models and system context
  ([`b9ca8f4`](https://github.com/romain-gilliotte/spectral/commit/b9ca8f4a7e8fdaa221ecf964a15b10b14bc2b635))
...
- Lazy-import decode_base64 in http.py and reformat frozenset
  ([`d56c603`](https://github.com/romain-gilliotte/spectral/commit/d56c6037a20b905d415e14e490aec9a49e470b03))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Llm-first analysis with mechanical verification
  ([`454d87e`](https://github.com/romain-gilliotte/spectral/commit/454d87ef7eaf6907ceaa3b9959d05f576623c12a))
...
- Make pipeline protocol-agnostic via ProtocolBranch abstraction
  ([`2806f66`](https://github.com/romain-gilliotte/spectral/commit/2806f66bf791ba743ada1f6f1cb1b6e5805e0b3a))
...
- Merge cmd.py into __init__.py for all command packages
  ([`4fb3711`](https://github.com/romain-gilliotte/spectral/commit/4fb37114670adabf3a273d36731c2fe9d3e3dba7))
...
- Migrate ask_text JSON calls to ask_json with Pydantic models
  ([`54c82a3`](https://github.com/romain-gilliotte/spectral/commit/54c82a3ff253937d813ba48bf55ce4f514aeb345))
...
- Move auth_framework into cli/commands/auth/
  ([`9ee4eca`](https://github.com/romain-gilliotte/spectral/commit/9ee4eca669d93d8304050636d11dc49cb4738433))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Move command packages under cli/commands/, shared utils under cli/helpers/
  ([`a38037b`](https://github.com/romain-gilliotte/spectral/commit/a38037b8c0ddf904b15dd8d85f8477426a479e5c))
...
- Move debug_dir into llm.init() instead of threading through pipeline
  ([`06baa06`](https://github.com/romain-gilliotte/spectral/commit/06baa06a327b84dc4e5a3fe67a31c66f58d71f53))

Co-Authored-By: Claude Opus 4.6 <noreply@anthropic.com>

- Move extract_json and reformat helpers from llm.py into cli/helpers/json/
  ([`33bec24`](https://github.com/romain-gilliotte/spectral/commit/33bec249c6a591452d7090a93b2168f14df5f010))
...
- Move proxy to capture group, add android cert command
  ([`d10af2e`](https://github.com/romain-gilliotte/spectral/commit/d10af2e599c928e2063ffa27a89c44d5f4a435f8))
...
- Move subprocess.py into android/external_tools
  ([`bdac403`](https://github.com/romain-gilliotte/spectral/commit/bdac403b3b16da2884b86619e7c35a2d72f6a8b3))
...
- Move transport layer to _client.py and rewrite helper tests
  ([`4e06bca`](https://github.com/romain-gilliotte/spectral/commit/4e06bca27741814bb86d31eca296656482cf3bf7))
...
- Move truncate() into capture/cmd.py as private helper
  ([`cc122a3`](https://github.com/romain-gilliotte/spectral/commit/cc122a32ac8be48a96ec9bb367a8493480058e56))
...
- Output OpenAPI 3.1 directly, remove generate and client commands
  ([`1d7d16d`](https://github.com/romain-gilliotte/spectral/commit/1d7d16ddf527d0c0b29c164d3836d17c1e7528e7))
...
- Relocate misplaced code to proper modules
  ([`fab0d40`](https://github.com/romain-gilliotte/spectral/commit/fab0d40cdc9a30ca7edf6e0dfb0454cf98af5fdf))
...
- Remove auth analysis from all analysis pipelines
  ([`0ceb2ef`](https://github.com/romain-gilliotte/spectral/commit/0ceb2efddb35ec38c292416226488d514d43e713))
...
- Remove cleanup step, add inspect_context tool, use centralized cost estimation
  ([`8e01bd2`](https://github.com/romain-gilliotte/spectral/commit/8e01bd260a242e52316ff9b58df4c6189b341d33))
...
- Remove dead AUTH_FRAMEWORK_CODE and generate_auth_script
  ([`b15f076`](https://github.com/romain-gilliotte/spectral/commit/b15f07678971151b209accd61144667c9a1bbc51))
...
- Remove dead run_proxy function after managed storage migration
  ([`0ec4ac9`](https://github.com/romain-gilliotte/spectral/commit/0ec4ac99ff89a2dfc3f1e1590d4bcae25631c280))
...
- Remove HAR import/export support
  ([`0968106`](https://github.com/romain-gilliotte/spectral/commit/0968106cbbad7183d3175d060c50a8c457a927d8))
...
- Remove Restish, rewrite docs for MCP-first narrative
  ([`be4024d`](https://github.com/romain-gilliotte/spectral/commit/be4024def1674f0827c74e01a4466399786567cb))
...
- Rename schema key "observed" → "examples" and delete _observed_to_examples
  ([`9816dc9`](https://github.com/romain-gilliotte/spectral/commit/9816dc9335276eaf8b370ab206185bb41c374a08))
...
- Replace 50 inline pyright ignores with 8 file-level directives
  ([`758efd5`](https://github.com/romain-gilliotte/spectral/commit/758efd5ec547fa61cda1f4304cdab0153b3fd0f9))
...
- Replace monolithic analysis with step-based pipeline architecture
  ([`cc82e4f`](https://github.com/romain-gilliotte/spectral/commit/cc82e4fec76ed4a8682fb2413c79b6a0864d6912))
...
- Restructure CLI into openapi/graphql/mcp command groups
  ([`959783b`](https://github.com/romain-gilliotte/spectral/commit/959783b0b4e1c50210ac5c9a73c76cd887db3696))
...
- Restructure login fix flow into separate functions
  ([`9ea3c0c`](https://github.com/romain-gilliotte/spectral/commit/9ea3c0ceb0b6d9d900d55f3286a26669239fedd8))
...
- Restructure test suite into subdirectories mirroring source layout
  ([`a288c94`](https://github.com/romain-gilliotte/spectral/commit/a288c94e6a10ea82d3b99210273477974d6b41e5))
...
- Simplify _strip_non_leaf_observed into single generic recursion
  ([`0906bab`](https://github.com/romain-gilliotte/spectral/commit/0906babd470381d67e9bc5ac805ce339a870f73f))
...
- Simplify GraphQL detection in MITM proxy
  ([`4831f86`](https://github.com/romain-gilliotte/spectral/commit/4831f86f1bb72be4faea45fdaa5eb8b7c53e2c72))
...
- Simplify Step classes and centralize model in llm.py
  ([`2084559`](https://github.com/romain-gilliotte/spectral/commit/20845591ed13f25ec3321505f24cd8e5802e0c8f))
...
- Simplify URL counting in detect_base_url
  ([`2ec2191`](https://github.com/romain-gilliotte/spectral/commit/2ec219135f89dc9da78aa292afecf69310060cdd))
...
- Split auth helper into two-layer architecture with static framework
  ([`bde39d7`](https://github.com/romain-gilliotte/spectral/commit/bde39d70926ba76cb368e61389f3fbfdee64401c))
...
- Split CLAUDE.md into scoped rule files
  ([`7d0d8ee`](https://github.com/romain-gilliotte/spectral/commit/7d0d8eec4697e5dede5cb0f5b2ad3edc520a3b1a))
...
- Split CLI commands out of main.py into per-module cmd.py files
  ([`d6f979b`](https://github.com/romain-gilliotte/spectral/commit/d6f979b497792bbb51d7888c6e3ca269b85b521c))
...
- Split discovery into separate command, proxy MITMs all by default
  ([`9f4a2d8`](https://github.com/romain-gilliotte/spectral/commit/9f4a2d86a54660af3ae780964d30d12d8e14cc5a))
...
- Split enrichment into parallel per-endpoint LLM calls
  ([`f47141b`](https://github.com/romain-gilliotte/spectral/commit/f47141b23bf3451523b34e537deb483cfae3d342))
...
- Split json schema inference into pure sync + async analysis layers
  ([`4fffcdd`](https://github.com/romain-gilliotte/spectral/commit/4fffcddbc16241b079e6ef6a12397ae5d67e89c0))
...
- Split llm.py into cli/helpers/llm/ package with Conversation class
  ([`cd75adc`](https://github.com/romain-gilliotte/spectral/commit/cd75adcba9309b8f14c0fca036c6bd4831eb0c29))
...
- Unify internal dataclass files to types.py convention
  ([`0574ecd`](https://github.com/romain-gilliotte/spectral/commit/0574ecd5ac5e20d9d0b5ee34b594befb5b53981f))
...
- Add GraphQL alias handling test for extraction
  ([`151edaa`](https://github.com/romain-gilliotte/spectral/commit/151edaae2d54e1d66144ca3c1652898f8f815247))
